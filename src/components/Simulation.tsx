...
export const defaultSimulationParams: SimulationParams = {
    ...
    plantParams: {
        startingCount: 40,
        spawnRate: 13,
        satietyValue: new RandomizedStat(50, 15),
        oldAge: new RandomizedStat(14, 5),
        radius: 5,
        color: "#1a9e00"
    },
    species: [
        {
            ...
            startingCount: 170,
            inheritedStats: {
                maxSpeed: new RandomizedStat(50, 5),
                visionRadius: new RandomizedStat(100, 10),
                maxStamina: new RandomizedStat(50, 12),
                maxSatiety: new RandomizedStat(110, 20),
                oldAge: new RandomizedStat(180, 20),
                satietyValue: new RandomizedStat(60, 10),
            },
            satietyLoss: 2,
        ...
        },
        {
            ...
            startingCount: 25,
            inheritedStats: {
                maxSpeed: new RandomizedStat(80, 8),
                visionRadius: new RandomizedStat(110, 11),
                maxStamina: new RandomizedStat(70, 15),
                maxSatiety: new RandomizedStat(100, 15),
                oldAge: new RandomizedStat(240, 30),
                satietyValue: new RandomizedStat(80, 15),
            },
            satietyLoss: 2.5,
            reproductionCooldown: 23,
            reproductionCost: 20,
            mutationChance: 0.33,
            randomDeviation: 0.01,
            radius: 9,
